...
<body>
  ...
  <section id="vedioPlay">
    <div class="vedio ">
      ...
      // fetch videos
      $fetchVideos = mysqli_query($conn, "SELECT videos.location, videos.title,videos.id ,videos.discription FROM videos WHERE sub_topic='$viasubtopic' ");
      if ($fetchVideos) {

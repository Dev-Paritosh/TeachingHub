...
<body>
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            if ($fetchtopic) {
              while ($row = mysqli_fetch_assoc($fetchtopic)) {
                ...
                // 
                // <a href='like.php?type=vedio&id=$video_id'>
              }
            }
            ?>
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            if ($fetchsubtopic) {
              while ($row = mysqli_fetch_assoc($fetchsubtopic)) {
                ...
                // array_push($sub_topic_arr,$sub_topic);
                // echo "<div>";
                // echo "<p>$sub_topic</p>";
                // echo "<div>";
  ...
  <section id="vedioPlay">
    <div class="vedio ">
      ...
      // fetch videos
      $fetchVideos = mysqli_query($conn, "SELECT videos.location, videos.title,videos.id ,videos.discription FROM videos ");
      if ($fetchVideos) {
        while ($row = mysqli_fetch_assoc($fetchVideos)) {
          ...
          echo "<div>";
          echo "<div class='row' >";
          echo "<div class='col-lg-4 col-md-12 video'>";
          ...
          echo "<a class='no-like' href='like.php?type=vedio&id=$video_id'><i class='far fa-thumbs-up like-button' ></i> $no_of_likes</a>";
          // echo "$no_of_likes";
          echo "</div >";
          echo "</div >";
          echo "</div >";
